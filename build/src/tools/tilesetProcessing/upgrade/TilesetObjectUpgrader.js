...
const logger = base_1.Loggers.get("upgrade");
/**
...
class TilesetObjectUpgrader {
    ...
    async upgradeTilesetObject(tileset) {
        ...
        if (this.upgradeOptions.upgradeContentGltfExtensionDeclarations) {
            ...
            tilesets_2.Extensions.removeExtensionUsed(tileset, "3DTILES_content_gltf");
        }
    ...
    async upgradeEachContentUrlToUri(tileset) {
        ...
        await tilesets_1.Tiles.traverseExplicit(root, async (tilePath) => {
...
//# sourceMappingURL=TilesetObjectUpgrader.js.map