...
class StructuralMetadataPropertyTables {
    ...
    static createPropertyTableProperty(extStructuralMetadata, binaryPropertyTable, propertyId) {
        ...
        if (!propertyTablePropertiesJson) {
            throw new metadata_1.MetadataError(`The property table does not define any properties`);
        }
        const propertyTablePropertyJson = propertyTablePropertiesJson[propertyId];
        if (!propertyTablePropertyJson) {
            throw new metadata_1.MetadataError(`The property table does not define property ${propertyId}`);
        }
