...
export { EXTMeshFeatures } from "./gltfExtensions/EXTMeshFeatures";
...
export { EXTStructuralMetadata } from "./gltfExtensions/EXTStructuralMetadata";
export { PropertyTablePropertyOffsetType } from "./gltfExtensions/EXTStructuralMetadata";
