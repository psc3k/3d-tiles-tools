...
class ImplicitTraversedTile {
    constructor(implicitTiling, resourceResolver, tileset, root, path, subtreeModel, globalLevel, globalCoordinate, rootCoordinate, localCoordinate, parent) {
        /**
    ...
    async createNextSubtreeLevelChildren() {
        ...
        for (const localChildCoordinate of localChildCoordinates) {
            ...
            if (childSubtreeAvailable) {
                ...
                const traversedChild = new ImplicitTraversedTile(this._implicitTiling, this._resourceResolver, this._tileset, this._root, childPath, childSubtreeModel, this._globalLevel + 1, globalChildCoordinate, globalChildCoordinate, childLocalCoordinate, this);
    ...
    async createDirectChildren() {
        ...
        for (const localChildCoordinate of localChildCoordinates) {
            ...
            if (available) {
                ...
                const coordinateString = ImplicitTilings_1.ImplicitTilings.createString(globalChildCoordinate);
                const childPath = `${this._root.path}/${coordinateString}`;
                const traversedChild = new ImplicitTraversedTile(this._implicitTiling, this._resourceResolver, this._tileset, this._root, childPath, this._subtreeModel, this._globalLevel + 1, globalChildCoordinate, this._rootCoordinate, localChildCoordinate, this);
                traversedChildren.push(traversedChild);
            }
        }
        return traversedChildren;
    ...
    getRawContents() {
        ...
        for (const contentAvailabilityInfo of contentAvailabilityInfos) {
            ...
            if (available) {
                ...
                if ((0, base_1.defined)(templateUri)) {
...
//# sourceMappingURL=ImplicitTraversedTile.js.map