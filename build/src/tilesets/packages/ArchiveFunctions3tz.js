...
class ArchiveFunctions3tz {
    ...
    static getFileContents(fd, buffer, expectedFilename) {
        ...
        const localFileHeaderBuffer = Buffer.alloc(ArchiveFunctions3tz.ZIP_LOCAL_FILE_HEADER_STATIC_SIZE);
        fs_1.default.readSync(fd, localFileHeaderBuffer, 0, ArchiveFunctions3tz.ZIP_LOCAL_FILE_HEADER_STATIC_SIZE, offset);
        ...
        const localFileDataOffset = offset +
            BigInt(ArchiveFunctions3tz.ZIP_LOCAL_FILE_HEADER_STATIC_SIZE +
                local_filename_size +
                local_extra_size);
        fs_1.default.readSync(fd, localFileDataBuffer, 0, local_comp_size, localFileDataOffset);
...
//# sourceMappingURL=ArchiveFunctions3tz.js.map