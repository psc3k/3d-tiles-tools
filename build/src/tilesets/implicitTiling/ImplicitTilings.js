...
class ImplicitTilings {
    ...
    static computeNumberOfNodesPerSubtree(implicitTiling) {
        ...
        if (implicitTiling.subdivisionScheme === "QUADTREE") {
            return base_1.Quadtrees.computeNumberOfNodesForLevels(levels);
        }
        if (implicitTiling.subdivisionScheme === "OCTREE") {
            return base_3.Octrees.computeNumberOfNodesForLevels(levels);
        }
    ...
    static createString(coordinates) {
        if (coordinates instanceof base_2.QuadtreeCoordinates) {
        ...
        if (coordinates instanceof base_4.OctreeCoordinates) {
            const level = coordinates.level;
            const x = coordinates.x;
            const y = coordinates.y;
    ...
    static createRootCoordinates(implicitTiling) {
        ...
        if (subdivisionScheme === "QUADTREE") {
            return new base_2.QuadtreeCoordinates(0, 0, 0);
        }
        if (subdivisionScheme === "OCTREE") {
            return new base_4.OctreeCoordinates(0, 0, 0, 0);
        }
        throw new ImplicitTilingError_1.ImplicitTilingError(`Invalid subdivisionScheme: ${subdivisionScheme}`);
    }
    /**
    ...
    static globalizeQuadtreeCoords(rootCoords, localCoords) {
        ...
        const globalCoords = new base_2.QuadtreeCoordinates(globalLevel, globalX, globalY);
        return globalCoords;
    }
    /**
    ...
    static globalizeOctreeCoords(rootCoords, localCoords) {
        ...
        const globalCoords = new base_4.OctreeCoordinates(globalLevel, globalX, globalY, globalZ);
        return globalCoords;
    }
}
exports.ImplicitTilings = ImplicitTilings;
//# sourceMappingURL=ImplicitTilings.js.map