...
exports.ImplicitTilingError = void 0;
/**
 ...
 * @internal
 */
class ImplicitTilingError extends Error {
    constructor(message) {
        super(message);
        this.toString = () => {
...
exports.ImplicitTilingError = ImplicitTilingError;
//# sourceMappingURL=ImplicitTilingError.js.map