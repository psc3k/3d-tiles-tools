...
exports.Octrees = void 0;
const OctreeCoordinates_1 = require("./OctreeCoordinates");
/**
        ...
        for (let z = 0; z < size; z++) {
            for (let y = 0; y < size; y++) {
                for (let x = 0; x < size; x++) {
                    yield new OctreeCoordinates_1.OctreeCoordinates(level, x, y, z);
                }
            }
        }
    }
...
exports.Octrees = Octrees;
//# sourceMappingURL=Octrees.js.map