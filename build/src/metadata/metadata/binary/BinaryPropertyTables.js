...
class BinaryPropertyTables {
    ...
    static createPropertyTableProperty(classProperty, schema, values, arrayOffsetType, stringOffsetType, bufferViewsData) {
        ...
        const isVariableLengthArray = classProperty.array && !(0, base_1.defined)(classProperty.count);
    ...
    static createBinaryPropertyTable(schema, className, propertyName, values, arrayOffsetType, stringOffsetType) {
        ...
        const binaryBufferStructure = base_3.BinaryBuffers.createBinaryBufferStructure(binaryBufferData, createdBufferViewsData);
    ...
    static createValuesBuffer(classProperty, schema, values) {
        ...
        if ((0, base_1.defined)(enumType)) {
            ...
            componentType = (0, base_2.defaultValue)(metadataEnum.valueType, "UINT16");
    ...
    static createStringOffsetBuffer(values, offsetType) {
        ...
        offsetType = (0, base_2.defaultValue)(offsetType, "UINT32");
...
//# sourceMappingURL=BinaryPropertyTables.js.map